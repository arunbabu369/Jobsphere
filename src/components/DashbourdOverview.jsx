...
function DashbourdOverview() {
  ...
  return (
    <div className="container mx-auto pt-8 px-4"> 
      <h1 className="text-4xl font-bold mb-8 text-gray-800">Welcome, {currentuser.username}!</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
          <h2 className="text-xl font-semibold text-blue-600 mb-4">Saved Jobs</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
          <h2 className="text-xl font-semibold text-green-600 mb-4">Your Applications</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
          <h2 className="text-xl font-semibold text-purple-600 mb-4">Profile Completion</h2>
