...
function Searchjobpage() {
  ...
  return (
    <>
    <h1 className='text-center text-5xl font-semibold text-indigo-700 my-4 shadow'>Discover Your Dream Job</h1>
   
    <div className='flex flex-col md:flex-row mx-auto'>
      <div className='p-6 rounded-md shadow-md md:w-1/4 sticky top-6 self-start'>
        <h2 className='font-inter text-xl text-center'>Filters</h2>
        
        <div className='mb-6'>
          <label htmlFor="type" className='text-md font-inter text-gray-700'>Job Type:</label>
