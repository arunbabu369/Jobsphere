...
useEffect(() => {
  ...
  return (
    <div>
      <div className='h-[300px] bg-gray-100 flex items-center pl-20 gap-10'>
        <img className='h-40 w-40 rounded-3xl' src={techinnovation} alt="" />
        <h1 className='text-2xl font-inter'>{job.title}</h1>
      </div>
      <div className='flex'>
        <div className='w-2/3 px-20 my-20'>
            <h1 className='text-xl font-semibold'>Job Description</h1>
            <p className='mt-8'>{job.description}</p>
            <p className='mt-8 font-semibold'>Company Name : {job.company}</p>
            <p className='mt-8'><strong className='font-semibold'>Location : </strong>{job.location}</p>
            <p className='mt-8'><strong className='font-semibold'>Job-Type : </strong>{job.type}</p>
            <p className='mt-8'><strong className='font-semibold'>Position : </strong>{job.title}</p>
        </div>
        
        <div className='w-1/3 pr-20 my-20'>
            {currentuser?
            (<button className='w-full px-8 py-4 bg-blue-800 text-white text-2xl'
              onClick={()=>{
            ...
            </button>):(<button className='w-full px-8 py-4 bg-blue-800 text-white text-2xl'
            ...
            <div className='bg-gray-100 mt-10'>
              ...
              <h1 className='text-center p-6 text-xl'>Job Summary</h1>
              </div>
             ...
             <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/>
               ...
               <div className='ml-6'>
               <p className='text-semibold text-lg'>Location</p>
               ...
               <div className='ml-6'>
               <p className='text-semibold text-lg'>Job-Type</p>
               ...
               <div className='ml-6'>
               <p className='text-semibold text-lg'>Salary</p>
               ...
               <div className='ml-6'>
               <p className='text-semibold text-lg'>Posted On</p>
     ...
     {applyModal && (
      <div className='fixed inset-0 bg-gray-600 flex justify-center items-center'>
        <div className='bg-white p-8 rounded-lg shadow-xl max-w-md w-full relative'>
          ...
          <h2 className='text-2xl mb-4'>Apply For {job.title}</h2>
